...
| **Mock Shelby Storage**| **Staging Verified** | File upload & download E2E | Persisted on disk; verified SHA-256 matches uploads on staging |
...
| **Live SDK Verification** | **Blocked** | Live upload/download fails due to @shelby-protocol/sdk packaging CommonJS import resolver error | Resolve SDK CommonJS export packaging mismatch. |
